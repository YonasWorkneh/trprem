...
import { Order } from "@/lib/store/tradingStore";
...
function AdminDashboardContent() {
    ...
    const handleAdjustBalance = async (userId: string) => {
        ...
        try {
            ...
            toast.success(
                `Successfully ${adjustType === "credit" ? "credited" : "debited"
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    <div className="hidden md:block">
                        <TabsList className="grid w-full max-w-2xl grid-cols-6 gap-2">
                            ...
                            <TabsTrigger value="sends" className="flex items-center justify-center">
                            ...
                            <SheetContent side="left" className="w-[280px]" {...({} as any)}>
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="mt-6 space-y-2">
                                        {["users", "deposits", "withdrawals", "sends", "settings", "support"].map((tab) => (
                                            <Button
                                                key={tab}
                ...
                <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
                    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            ...
                            <DialogDescription>Manage user account, balance and KYC</DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-bold text-primary">
                                            ${userDetails?.total_balance?.toFixed(2) || "0.00"}
                                        </span>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-sm font-medium">Adjust Balance</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    ...
                                    <Button
                                        className="w-full"
                                        onClick={() => selectedUser && handleAdjustBalance(selectedUser.id)}
                                    >
                                        Apply Adjustment
                                    </Button>
                                </CardContent>
                            ...
                            {selectedUser?.kyc_status !== "not_started" && (
                                <Card className="md:col-span-2">
                                    <CardHeader>
                                        <CardTitle className="text-sm font-medium">KYC Verification Documents</CardTitle>
                                    </CardHeader>
                                            ...
                                            <div className="space-y-6">
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <div className="space-y-2">
                                                        ...
                                                        <img src={kycDetails.id_front_url} className="w-full h-40 object-cover rounded-lg border" />
                                                    </div>
                                                    <div className="space-y-2">
                                                        <Label>ID Back</Label>
                                                        <img src={kycDetails.id_back_url} className="w-full h-40 object-cover rounded-lg border" />
                                                    </div>
                                                    <div className="space-y-2">
                                                        <Label>Selfie</Label>
                                                        <img src={kycDetails.selfie_url} className="w-full h-40 object-cover rounded-lg border" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex gap-4">
                                                    <Button
                                                        ...
                                                        onClick={() => selectedUser?.id && updateKycStatus(selectedUser.id, "verified")}
                                                    >
                                                        Approve KYC
                                                    </Button>
                                                    <Button
                                                        variant="destructive"
                                                        className="flex-1"
                                                        onClick={() => selectedUser?.id && updateKycStatus(selectedUser.id, "rejected")}
                                                    >
                                                        Reject KYC
                                                    </Button>
                                                </div>
